 ...
 *     @property
 */
  set_interactive(__pyx_v_interactive);
 ...
 *     @property
 */
  __pyx_t_2 = __Pyx_PyInt_As_int(__pyx_v_value); if (unlikely((__pyx_t_2 == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 18, __pyx_L1_error)
  set_interactive(__pyx_t_2);
