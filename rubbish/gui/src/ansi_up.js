...
(function (factory) {
  ...
  var AnsiUp = (function () {
    ...
    AnsiUp.prototype.detect_incomplete_ansi = function (txt) {
      if (/.*?[\x40-\x7e]/.test(txt) == false) return true;
      return false;
    };
    AnsiUp.prototype.ansi_to_html = function (txt) {
      ...
      var blocks = raw_text_pkts.map(function (block) {
        return _this.wrap_text(_this.process_ansi(block));
      });
    ...
    AnsiUp.prototype.ansi_to_text = function (txt) {
      ...
      var blocks = raw_text_pkts.map(function (block) {
        return _this.process_ansi(block);
      });
      if (first_txt.length > 0) blocks.unshift(first_txt);
      return blocks.join("");
    };
    AnsiUp.prototype.wrap_text = function (txt) {
      ...
      if (this._escape_for_html) txt = this.old_escape_for_html(txt);
